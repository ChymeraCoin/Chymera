...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the chymera repository."
  exit 1
fi
...
# See https://github.com/chymera/chymera/issues/16064
...
echo 'When compiling chymerad, run `./configure` in the following way:'
echo
