 ...
 */
#ifndef chymera_UTIL_STRENCODINGS_H
#define chymera_UTIL_STRENCODINGS_H
...
/**
* Return true if the string is a hex number, optionally prefixed with "cx"
*/
...
#endif // chymera_UTIL_STRENCODINGS_H
