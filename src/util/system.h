 ...
 */
#ifndef chymera_UTIL_SYSTEM_H
#define chymera_UTIL_SYSTEM_H
...
extern const char * const chymera_CONF_FILENAME;
extern const char * const chymera_SETTINGS_FILENAME;
