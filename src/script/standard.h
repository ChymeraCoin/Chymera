...
#ifndef chymera_SCRIPT_STANDARD_H
#define chymera_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a chymera address
 */
...
/**
 * Generate a chymera scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // chymera_SCRIPT_STANDARD_H
