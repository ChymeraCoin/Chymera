...
bool CoinStatsIndex::WriteBlock(const CBlock& block, const CBlockIndex* pindex)
{
    ...
    if (pindex->nHeight > 0) {
        ...
        bool is_bip30_block{(pindex->nHeight == 91722 && pindex->GetBlockHash() == uint256S("cx00000000000271a2dc26e7667f8419f2e15416dc6955e5a6c6cdf3f2574dd08e")) ||
                            (pindex->nHeight == 91812 && pindex->GetBlockHash() == uint256S("cx00000000000af0aed4792b1acee3d966af36cf5def14935db8de83d6f9306f2f"))};
