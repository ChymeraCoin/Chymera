// Copyright (c) 2018-2019 The chymera Core developers
...
__m128i inline Read4(const unsigned char* chunk, int offset) {
    ...
    return _mm_shuffle_epi8(ret, _mm_set_epi32(cx0C0D0E0FUL, cx08090A0BUL, cx04050607UL, cx00010203UL));
}

void inline Write4(unsigned char* out, int offset, __m128i v) {
    v = _mm_shuffle_epi8(v, _mm_set_epi32(cx0C0D0E0FUL, cx08090A0BUL, cx04050607UL, cx00010203UL));
...
{
    // Transform 1
    __m128i a = K(cx6a09e667ul);
    __m128i b = K(cxbb67ae85ul);
    __m128i c = K(cx3c6ef372ul);
    __m128i d = K(cxa54ff53aul);
    __m128i e = K(cx510e527ful);
    __m128i f = K(cx9b05688cul);
    __m128i g = K(cx1f83d9abul);
    __m128i h = K(cx5be0cd19ul);

    __m128i w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15;

    Round(a, b, c, d, e, f, g, h, Add(K(cx428a2f98ul), w0 = Read4(in, 0)));
    Round(h, a, b, c, d, e, f, g, Add(K(cx71374491ul), w1 = Read4(in, 4)));
    Round(g, h, a, b, c, d, e, f, Add(K(cxb5c0fbcful), w2 = Read4(in, 8)));
    Round(f, g, h, a, b, c, d, e, Add(K(cxe9b5dba5ul), w3 = Read4(in, 12)));
    Round(e, f, g, h, a, b, c, d, Add(K(cx3956c25bul), w4 = Read4(in, 16)));
    Round(d, e, f, g, h, a, b, c, Add(K(cx59f111f1ul), w5 = Read4(in, 20)));
    Round(c, d, e, f, g, h, a, b, Add(K(cx923f82a4ul), w6 = Read4(in, 24)));
    Round(b, c, d, e, f, g, h, a, Add(K(cxab1c5ed5ul), w7 = Read4(in, 28)));
    Round(a, b, c, d, e, f, g, h, Add(K(cxd807aa98ul), w8 = Read4(in, 32)));
    Round(h, a, b, c, d, e, f, g, Add(K(cx12835b01ul), w9 = Read4(in, 36)));
    Round(g, h, a, b, c, d, e, f, Add(K(cx243185beul), w10 = Read4(in, 40)));
    Round(f, g, h, a, b, c, d, e, Add(K(cx550c7dc3ul), w11 = Read4(in, 44)));
    Round(e, f, g, h, a, b, c, d, Add(K(cx72be5d74ul), w12 = Read4(in, 48)));
    Round(d, e, f, g, h, a, b, c, Add(K(cx80deb1feul), w13 = Read4(in, 52)));
    Round(c, d, e, f, g, h, a, b, Add(K(cx9bdc06a7ul), w14 = Read4(in, 56)));
    Round(b, c, d, e, f, g, h, a, Add(K(cxc19bf174ul), w15 = Read4(in, 60)));
    ...
    // Output
    Write4(out, 0, Add(a, K(cx6a09e667ul)));
    Write4(out, 4, Add(b, K(cxbb67ae85ul)));
    Write4(out, 8, Add(c, K(cx3c6ef372ul)));
    Write4(out, 12, Add(d, K(cxa54ff53aul)));
    Write4(out, 16, Add(e, K(cx510e527ful)));
    Write4(out, 20, Add(f, K(cx9b05688cul)));
    Write4(out, 24, Add(g, K(cx1f83d9abul)));
    Write4(out, 28, Add(h, K(cx5be0cd19ul)));
}
