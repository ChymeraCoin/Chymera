...
#ifndef chymera_CRYPTO_CHACHA_POLY_AEAD_H
#define chymera_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@chymera.
 *
 ...
 *
 * The chacha20-poly1305@chymera combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@chymera cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@chymera are relatively fast in
...
#endif // chymera_CRYPTO_CHACHA_POLY_AEAD_H
