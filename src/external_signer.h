// Copyright (c) 2018-2021 The chymera Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef chymera_EXTERNAL_SIGNER_H
#define chymera_EXTERNAL_SIGNER_H
...
#endif // chymera_EXTERNAL_SIGNER_H
