...
constexpr static struct {
    ...
    {4, cxa4a3e223}, {2, cx15c32f9e}, {1, cx0375b547}, {1, cx7004a8a5},
    {2, cxce440296}, {2, cx52cfe198}, {1, cx77a72cd0}, {2, cxbb5d6f84},
    {2, cx83f30c2c}, {1, cx48a73d5b}, {1, cxef7dcd01}, {2, cx6809c6c4},
    {2, cx0883ab3c}, {1, cx087bbbe2}, {2, cx2104a814}, {2, cxdffb6daa},
    {1, cxee8a0a08}, {2, cxba4237c1}, {1, cxa70349dc}, {1, cx344722bb},
    {3, cxd6294733}, {2, cxec9f5c94}, {2, cxca2fbc28}, {1, cx6ba4f406},
    {2, cx015d4532}, {1, cx6e119b7c}, {2, cx43e8f314}, {2, cx27962f38},
    {2, cxb571b51b}, {2, cxb36bee23}, {2, cxd17924a8}, {2, cx6bc212d9},
    {1, cx630d4948}, {2, cx9a4c4ebb}, {2, cx554be537}, {1, cxd63ddfc7},
    {2, cxa10acc11}, {1, cx759a8363}, {2, cxfb73090d}, {1, cxe82c6a34},
    {1, cxe33e92d7}, {3, cx658ef5cb}, {2, cxba32ff22}, {5, cx0227a10c},
    {1, cxa9a70155}, {5, cxd096d809}, {1, cx37176174}, {1, cx830b8d0f},
    {1, cxc6e3910e}, {2, cx823f3ca8}, {1, cx99850849}, {1, cx7521fb81},
    {1, cxaacaabab}, {1, cxd645a2eb}, {5, cx7aea1781}, {5, cx9d6e4b78},
    {1, cx4ce90fd8}, {1, cxabdc832d}, {6, cx4a34f32a}, {2, cxf2524c1c},
    {2, cx1bbeb08a}, {1, cxad47f480}, {1, cx9f026aeb}, {1, cx15a95049},
    {2, cxd1cb95b2}, {2, cxf84bbda5}, {1, cx0fa62cd1}, {1, cxe05f9169},
    {1, cx78d194a9}, {5, cx3e38147b}, {5, cx737ba0d4}, {1, cx63378e10},
    {1, cx6d5f91cf}, {2, cx88612eb8}, {2, cxe9639484}, {1, cxb7fabc9d},
    {2, cx19b01592}, {1, cx5a90dd31}, {2, cx5bd7e028}, {2, cx94d00323},
    {1, cxa9b9c01a}, {1, cx3a40de61}, {1, cx56e7eec7}, {5, cx859f7ef6},
    {1, cxfd8e5630}, {1, cx2b0c9f7f}, {1, cxba700e26}, {1, cx7170a408},
    {1, cx70de86a8}, {1, cx74d64cd5}, {1, cx49e738a1}, {2, cx6910b602},
    {0, cx643c565f}, {1, cx54264b3f}, {2, cx97ea6396}, {2, cx55174459},
    {2, cx03e8779a}, {1, cx98f34d8f}, {1, cxc07b2b07}, {1, cxdfe29668},
    {1, cx3141c7c1}, {1, cxb3b595f4}, {1, cx735abf08}, {5, cx623bfbce},
    {2, cxd351e722}, {1, cxf4ca48c9}, {1, cx5b19c670}, {1, cxa164bf0e},
    {2, cxbbbeb305}, {2, cxfe1c810a},
};
...
void MinerTestingSetup::TestPackageSelection(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst)
{
    ...
    tx.vout[1].nValue = 100000000; // 1cmr output
