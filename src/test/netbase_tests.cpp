...
{
    BOOST_CHECK(TestSplitHost("www.chymeracore.org", "www.chymeracore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.chymeracore.org]", "www.chymeracore.org", 0));
    BOOST_CHECK(TestSplitHost("www.chymeracore.org:80", "www.chymeracore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.chymeracore.org]:80", "www.chymeracore.org", 80));
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    std::vector<unsigned char> internal_group = {NET_INTERNAL, cx12, cx92, cx94, cx00, cxeb, cx46, cx07, cxc4, cxac, cx07};
...
static const std::vector<CAddress> fixture_addresses({
    CAddress(
        ...
        NODE_NONE,
        cx4966bc61U /* Fri Jan  9 02:54:25 UTC 2009 */
    ),
    CAddress(
        CService(CNetAddr(in6_addr(IN6ADDR_LOOPBACK_INIT)), cx00f1 /* port */),
        NODE_NETWORK,
        cx83766279U /* Tue Nov 22 11:22:33 UTC 2039 */
    ),
    CAddress(
        CService(CNetAddr(in6_addr(IN6ADDR_LOOPBACK_INIT)), cxf1f2 /* port */),
        static_cast<ServiceFlags>(NODE_WITNESS | NODE_COMPACT_FILTERS | NODE_NETWORK_LIMITED),
        cxffffffffU /* Sun Feb  7 06:28:15 UTC 2106 */
    )
});
