...
BOOST_AUTO_TEST_CASE(cnetaddr_unserialize_v2)
{
    ...
    s << MakeSpan(ParseHex(
        ...
        "10"                                  // address length
        "fd6b88c08724ca978112ca1bbdcafac2")); // address: cxfd + sha256("chymera")[0:5] +
                                              // sha256(name)[0:10]
    s >> addr;
...
BOOST_AUTO_TEST_CASE(ipv4_peer_with_ipv6_addrMe_test)
{
    ...
    // !IsRoutable the undefined behavior is easier to trigger deterministically
    {
        ...
        ipv4AddrLocal.s_addr = cx0100007f;
    ...
    ipv4AddrPeer.s_addr = cxa0b0c001;
...
{
    CNetAddr addr = UtilBuildAddress(cx001, cx001, cx001, cx001); // 1.1.1.1
...
{
    CService addr = CService(UtilBuildAddress(cx002, cx001, cx001, cx001), 1000); // 2.1.1.1:1000
