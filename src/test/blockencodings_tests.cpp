...
BOOST_AUTO_TEST_CASE(TransactionsRequestDeserializationOverflowTest) {
    // Any set of index deltas that starts with N values that sum to (cx10000 - N)
    ...
    req0.indexes[0] = cx7000;
    req0.indexes[1] = cx10000 - cx7000 - 2;
    req0.indexes[2] = 0;
    CDataStream stream(SER_NETWORK, PROTOCOL_VERSION);
