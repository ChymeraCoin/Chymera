...
{
    std::vector<uint8_t> data{cx82, cxa7, cx31};
...
BOOST_AUTO_TEST_CASE(bitstream_reader_writer)
{
    ...
    BOOST_CHECK_EQUAL(serialized_int1, (uint32_t)cx7700C35A); // NOTE: Serialized as LE
    uint16_t serialized_int2;
    data >> serialized_int2;
    BOOST_CHECK_EQUAL(serialized_int2, (uint16_t)cx1072); // NOTE: Serialized as LE
