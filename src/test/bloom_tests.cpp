// Copyright (c) 2012-2020 The chymera Core developers
...
BOOST_AUTO_TEST_CASE(bloom_match)
{
    ...
    unsigned char ch[] = {cx01, cx00, cx00, cx00, cx01, cx6b, cxff, cx7f, cxcd, cx4f, cx85, cx65, cxef, cx40, cx6d, cxd5, cxd6, cx3d, cx4f, cxf9, cx4f, cx31, cx8f, cxe8, cx20, cx27, cxfd, cx4d, cxc4, cx51, cxb0, cx44, cx74, cx01, cx9f, cx74, cxb4, cx00, cx00, cx00, cx00, cx8c, cx49, cx30, cx46, cx02, cx21, cx00, cxda, cx0d, cxc6, cxae, cxce, cxfe, cx1e, cx06, cxef, cxdf, cx05, cx77, cx37, cx57, cxde, cxb1, cx68, cx82, cx09, cx30, cxe3, cxb0, cxd0, cx3f, cx46, cxf5, cxfc, cxf1, cx50, cxbf, cx99, cx0c, cx02, cx21, cx00, cxd2, cx5b, cx5c, cx87, cx04, cx00, cx76, cxe4, cxf2, cx53, cxf8, cx26, cx2e, cx76, cx3e, cx2d, cxd5, cx1e, cx7f, cxf0, cxbe, cx15, cx77, cx27, cxc4, cxbc, cx42, cx80, cx7f, cx17, cxbd, cx39, cx01, cx41, cx04, cxe6, cxc2, cx6e, cxf6, cx7d, cxc6, cx10, cxd2, cxcd, cx19, cx24, cx84, cx78, cx9a, cx6c, cxf9, cxae, cxa9, cx93, cx0b, cx94, cx4b, cx7e, cx2d, cxb5, cx34, cx2b, cx9d, cx9e, cx5b, cx9f, cxf7, cx9a, cxff, cx9a, cx2e, cxe1, cx97, cx8d, cxd7, cxfd, cx01, cxdf, cxc5, cx22, cxee, cx02, cx28, cx3d, cx3b, cx06, cxa9, cxd0, cx3a, cxcf, cx80, cx96, cx96, cx8d, cx7d, cxbb, cx0f, cx91, cx78, cxff, cxff, cxff, cxff, cx02, cx8b, cxa7, cx94, cx0e, cx00, cx00, cx00, cx00, cx19, cx76, cxa9, cx14, cxba, cxde, cxec, cxfd, cxef, cx05, cx07, cx24, cx7f, cxc8, cxf7, cx42, cx41, cxd7, cx3b, cxc0, cx39, cx97, cx2d, cx7b, cx88, cxac, cx40, cx94, cxa8, cx02, cx00, cx00, cx00, cx00, cx19, cx76, cxa9, cx14, cxc1, cx09, cx32, cx48, cx3f, cxec, cx93, cxed, cx51, cxf5, cxfe, cx95, cxe7, cx25, cx59, cxf2, cxcc, cx70, cx43, cxf9, cx88, cxac, cx00, cx00, cx00, cx00, cx00};
    std::vector<unsigned char> vch(ch, ch + sizeof(ch) -1);
    CDataStream spendStream(vch, SER_DISK, CLIENT_VERSION);
    CTransaction spendingTx(deserialize, spendStream);

    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(uint256S("cxb4749f017444b051c44dfd2720e88f314ff94f3dd6d56d40ef65854fcd7fff6b"));
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256S("cx90c122d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b"), 0));
    BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx), "Simple Bloom filter didn't match COutPoint");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    COutPoint prevOutPoint(uint256S("cx90c122d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b"), 0);
    {
    ...
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256S("cx90c122d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b"), 1));
    BOOST_CHECK_MESSAGE(!filter.IsRelevantAndUpdate(tx), "Simple Bloom filter matched COutPoint for an output we didn't care about");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(COutPoint(uint256S("cx000000d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b"), 0));
    BOOST_CHECK_MESSAGE(!filter.IsRelevantAndUpdate(tx), "Simple Bloom filter matched COutPoint for an output we didn't care about");
}
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    filter.insert(uint256S("cx74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cx74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"));
    ...
    filter.insert(uint256S("cxdd1fd2a6fc16404faf339881a90adbde7f4f728691ac62e8f168809cdfae1053"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cxdd1fd2a6fc16404faf339881a90adbde7f4f728691ac62e8f168809cdfae1053"));
...
BOOST_AUTO_TEST_CASE(merkle_block_2)
{
    ...
    filter.insert(uint256S("cxe980fe9f792d014e73b95203dc1335c5f9ce19ac537a419e6df5b47aecb93b70"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cxe980fe9f792d014e73b95203dc1335c5f9ce19ac537a419e6df5b47aecb93b70"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[1].second == uint256S("cx28204cad1d7fc1d199e8ef4fa22f182de6258a3eaafe1bbe56ebdcacd3069a5f"));
    BOOST_CHECK(merkleBlock.vMatchedTxn[1].first == 1);

    BOOST_CHECK(merkleBlock.vMatchedTxn[2].second == uint256S("cx6b0f8a73a56c04b519f1883e8aafda643ba61a30bd1439969df21bea5f4e27e2"));
    BOOST_CHECK(merkleBlock.vMatchedTxn[2].first == 2);

    BOOST_CHECK(merkleBlock.vMatchedTxn[3].second == uint256S("cx3c1d7e82342158e4109df2e0b6348b6e84e403d8b4046d7007663ace63cddb23"));
...
BOOST_AUTO_TEST_CASE(merkle_block_2_with_update_none)
{
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[2].second == uint256S("cx3c1d7e82342158e4109df2e0b6348b6e84e403d8b4046d7007663ace63cddb23"));
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
    ...
    filter.insert(uint256S("cx63194f18be0af63f2c6bc9dc0f777cbefed3d9415c4af83f3ee3a3d669c00cb5"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cx63194f18be0af63f2c6bc9dc0f777cbefed3d9415c4af83f3ee3a3d669c00cb5"));
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].first == 0);
...
BOOST_AUTO_TEST_CASE(merkle_block_4)
{
    ...
    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // Match the last transaction
    filter.insert(uint256S("cx0a2a92f0bda4727d0a13eaddf4dd9ac6b5c61a1429e6b2b818f19b15df0ac154"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cx0a2a92f0bda4727d0a13eaddf4dd9ac6b5c61a1429e6b2b818f19b15df0ac154"));
    ...
    filter.insert(uint256S("cx02981fa052f0481dbc5868f4fc2166035a10f27a03cfd2de67326471df5bc041"));
    merkleBlock = CMerkleBlock(block, filter);
    BOOST_CHECK(merkleBlock.header.GetHash() == block.GetHash());

    BOOST_CHECK(merkleBlock.vMatchedTxn.size() == 2);

    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("cx02981fa052f0481dbc5868f4fc2166035a10f27a03cfd2de67326471df5bc041"));
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_p2pubkey_only)
{
    ...
    BOOST_CHECK(filter.contains(COutPoint(uint256S("cx147caa76786596590baa4e98f5d9f48b86c7765e489f7a6ff3360fe5c674360b"), 0)));
    // ... but not the 4th transaction's output (its not pay-2-pubkey)
    BOOST_CHECK(!filter.contains(COutPoint(uint256S("cx02981fa052f0481dbc5868f4fc2166035a10f27a03cfd2de67326471df5bc041"), 0)));
}
