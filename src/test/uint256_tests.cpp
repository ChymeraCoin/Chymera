...
BOOST_AUTO_TEST_CASE( basics ) // constructors, equality, inequality
{
    ...
    BOOST_CHECK(uint256S("cx"+R1L.ToString()) == R1L);
    BOOST_CHECK(uint256S("cx"+R2L.ToString()) == R2L);
    BOOST_CHECK(uint256S("cx"+ZeroL.ToString()) == ZeroL);
    BOOST_CHECK(uint256S("cx"+OneL.ToString()) == OneL);
    BOOST_CHECK(uint256S("cx"+MaxL.ToString()) == MaxL);
    ...
    BOOST_CHECK(uint160S("cx"+R1S.ToString()) == R1S);
    BOOST_CHECK(uint160S("cx"+R2S.ToString()) == R2S);
    BOOST_CHECK(uint160S("cx"+ZeroS.ToString()) == ZeroS);
    BOOST_CHECK(uint160S("cx"+OneS.ToString()) == OneS);
    BOOST_CHECK(uint160S("cx"+MaxS.ToString()) == MaxS);
