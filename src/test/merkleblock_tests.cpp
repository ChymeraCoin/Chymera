...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_found)
{
    ...
    // Last txn in block.
    uint256 txhash1 = uint256S("cx74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20");

    // Second txn in block.
    uint256 txhash2 = uint256S("cxf9fc751cb7dc372406a9f8d738d5e6f8f63bab71986a39cf36ee70ee17036d07");
...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_not_found)
{
    ...
    txids2.insert(uint256S("cxc0ffee00003bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"));
