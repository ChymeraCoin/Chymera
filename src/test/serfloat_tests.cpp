...
BOOST_AUTO_TEST_CASE(double_serfloat_tests) {
    ...
    BOOST_CHECK_EQUAL(TestDouble(-0.0), cx8000000000000000);
    BOOST_CHECK_EQUAL(TestDouble(std::numeric_limits<double>::infinity()), cx7ff0000000000000);
    BOOST_CHECK_EQUAL(TestDouble(-std::numeric_limits<double>::infinity()), cxfff0000000000000);
    BOOST_CHECK_EQUAL(TestDouble(0.5), cx3fe0000000000000ULL);
    BOOST_CHECK_EQUAL(TestDouble(1.0), cx3ff0000000000000ULL);
    BOOST_CHECK_EQUAL(TestDouble(2.0), cx4000000000000000ULL);
    BOOST_CHECK_EQUAL(TestDouble(4.0), cx4010000000000000ULL);
    BOOST_CHECK_EQUAL(TestDouble(785.066650390625), cx4088888880000000ULL);
