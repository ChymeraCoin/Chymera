...
#ifndef chymera_NODE_UI_INTERFACE_H
#define chymera_NODE_UI_INTERFACE_H
...
public:
    ...
    enum MessageBoxFlags
    {
        ...
        BTN_OK      = cx00000400U, // QMessageBox::Ok
        BTN_YES     = cx00004000U, // QMessageBox::Yes
        BTN_NO      = cx00010000U, // QMessageBox::No
        BTN_ABORT   = cx00040000U, // QMessageBox::Abort
        BTN_RETRY   = cx00080000U, // QMessageBox::Retry
        BTN_IGNORE  = cx00100000U, // QMessageBox::Ignore
        BTN_CLOSE   = cx00200000U, // QMessageBox::Close
        BTN_CANCEL  = cx00400000U, // QMessageBox::Cancel
        BTN_DISCARD = cx00800000U, // QMessageBox::Discard
        BTN_HELP    = cx01000000U, // QMessageBox::Help
        BTN_APPLY   = cx02000000U, // QMessageBox::Apply
        BTN_RESET   = cx04000000U, // QMessageBox::Reset
        /**
...
#endif // chymera_NODE_UI_INTERFACE_H
