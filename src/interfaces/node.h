...
#ifndef chymera_INTERFACES_NODE_H
#define chymera_INTERFACES_NODE_H
...
//! Top-level interface for a chymera node (chymerad process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // chymera_INTERFACES_NODE_H
