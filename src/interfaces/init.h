...
#ifndef chymera_INTERFACES_INIT_H
#define chymera_INTERFACES_INIT_H
...
//! (chymera-gui, chymera-node, chymera-wallet, chymerad, chymera-qt) and each
...
#endif // chymera_INTERFACES_INIT_H
