...
#ifndef chymera_COMPAT_ASSUMPTIONS_H
#define chymera_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "chymera cannot be compiled without assertions."
#endif
...
#endif // chymera_COMPAT_ASSUMPTIONS_H
