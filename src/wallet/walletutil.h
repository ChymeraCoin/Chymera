...
#ifndef chymera_WALLET_WALLETUTIL_H
#define chymera_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! chymera from opening the wallet, thinking it was newly created, and
...
#endif // chymera_WALLET_WALLETUTIL_H
