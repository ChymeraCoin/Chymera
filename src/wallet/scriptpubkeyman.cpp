...
const uint32_t BIP32_HARDENED_KEY_LIMIT = cx80000000;
...
void LegacyScriptPubKeyMan::DeriveNewChildKey(WalletBatch &batch, CKeyMetadata& metadata, CKey& secret, CHDChain& hd_chain, bool internal)
{
    ...
    // derive m/0'
    // use hardened derivation (child keys >= cx80000000 are hardened after bip32)
    ...
    do {
        ...
        // example: 1 | BIP32_HARDENED_KEY_LIMIT == cx80000001 == 2147483649
        if (internal) {
