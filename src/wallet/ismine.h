...
#ifndef chymera_WALLET_ISMINE_H
#define chymera_WALLET_ISMINE_H
 ...
 * https://github.com/chymera/chymera/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
