...
#ifndef chymera_WALLET_SCRIPTPUBKEYMAN_H
#define chymera_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The chymera Core wallet was originally a collection of unrelated private
...
#endif // chymera_WALLET_SCRIPTPUBKEYMAN_H
