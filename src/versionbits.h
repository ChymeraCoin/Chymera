...
#ifndef chymera_VERSIONBITS_H
#define chymera_VERSIONBITS_H
...
static const int32_t VERSIONBITS_TOP_BITS = cx20000000UL;
/** What bitmask determines whether versionbits is in use */
static const int32_t VERSIONBITS_TOP_MASK = cxE0000000UL;
