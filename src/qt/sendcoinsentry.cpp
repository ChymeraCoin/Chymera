// Copyright (c) 2011-2019 The chymera Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // normal chymera address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying chymera address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &chymeraAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
