...
#ifndef chymera_QT_chymeraGUI_H
#define chymera_QT_chymeraGUI_H
...
/**
  chymera GUI main class. This class represents the main window of the chymera UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class chymeraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit chymeraGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~chymeraGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a chymera wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed chymera Transaction from file or clipboard */
