...
#ifndef chymera_QT_GUIUTIL_H
#define chymera_QT_GUIUTIL_H
...
/** Utility functions used by the chymera Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "chymera:" URI into recipient object, return true on successful parsing
