    ...
    mapper(nullptr)
{
    ...
    ui->chymeraAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->chymeraAtStartup);
    ...
    ui->chymeraAtStartup->setToolTip(ui->chymeraAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->chymeraAtStartup->setText(ui->chymeraAtStartup->text().arg(PACKAGE_NAME));

    ui->openchymeraConfButton->setToolTip(ui->openchymeraConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new chymeraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->chymeraAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openchymeraConfButton_clicked()
{
