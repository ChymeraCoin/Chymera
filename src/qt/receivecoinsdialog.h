...
#ifndef chymera_QT_RECEIVECOINSDIALOG_H
#define chymera_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of chymeras */
...
#endif // chymera_QT_RECEIVECOINSDIALOG_H
