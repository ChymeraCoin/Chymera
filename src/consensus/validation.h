...
#ifndef chymera_CONSENSUS_VALIDATION_H
#define chymera_CONSENSUS_VALIDATION_H
    ...
    if (!block.vtx.empty()) {
        for (size_t o = 0; o < block.vtx[0]->vout.size(); o++) {
            ...
            if (vout.scriptPubKey.size() >= MINIMUM_WITNESS_COMMITMENT &&
                ...
                vout.scriptPubKey[1] == cx24 &&
                vout.scriptPubKey[2] == cxaa &&
                vout.scriptPubKey[3] == cx21 &&
                vout.scriptPubKey[4] == cxa9 &&
                vout.scriptPubKey[5] == cxed) {
                commitpos = o;
            }
        }
    }
...
#endif // chymera_CONSENSUS_VALIDATION_H
